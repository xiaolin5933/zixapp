...
-- 业务字段
    ...
    bfj_bsc               bigint not null,
    zyzj_bsc              bigint not null,
...
comment on column yspz_0012.id                   is '原始配置id';
...
comment on column yspz_0012.zjbd_type            is '资金变动类型';
comment on column yspz_0012.zjbd_type_zjdb       is '资金变动类型 - 资金调拨';
comment on column yspz_0012.bi                   is '银行接口编号';
