...
-- 出款勾兑不成功（我有银无）
--
drop table yspz_0020;
create table yspz_0020 (
...
comment on column yspz_0020.cust_proto           is '客户协议编号';
comment on column yspz_0020.tx_amt               is '出款金额';
comment on column yspz_0020.cfee                 is '备付金内扣客户手续费金额';
comment on column yspz_0020.cwws_cfee            is '财务外收客户手续费金额';
comment on column yspz_0020.cfee_back            is '退回备付金内扣客户手续费金额';
comment on column yspz_0020.cwws_cfee_back       is '退回财务外收客户手续费金额';

comment on column yspz_0020.flag                 is '撤销标志';
comment on column yspz_0020.revoke_cause         is '撤销原因';
comment on column yspz_0020.ts_revoke            is '撤销时间';
comment on column yspz_0020.revoke_user          is '撤销者';
comment on column yspz_0020.memo                 is '说明';
comment on column yspz_0020.ts_c                 is '创建时间';

-- seq

drop sequence seq_yspz_0020;
create sequence seq_yspz_0020 as bigint start with 1 increment by 1 minvalue 1 no maxvalue no cycle cache 200 order;
