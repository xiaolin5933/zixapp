...
-- book
insert into dict( type, key, val, comment) values
       ('book', '2005.02',     'bamt_yhyf',     '应付银行-已核应付银行款' ),
       ('book', '1020.03',     'bamt_yhys',     '应收银行-已核应收银行款' ),
       ('book', '2005.03',     'bfee_yhyf',     '应付银行-已核应付银行手续费' ),
       ('book', '1020.04',     'bfee_yhys',     '应收银行-已核应收银行手续费' ),
       ('book', '2010.01',     'bfj_cust',      '客户备付金-备付金' ),
       ('book', '2202.01.001', 'blc',           '应付账款-银行-银行长款' ),
       ('book', '2202.01.002', 'blc_zyzj',      '应付账款-银行-银行长款' ),
       ('book', '1122.02.001', 'bsc',           '应收账款-银行-银行短款' ),
       ('book', '1122.02.002', 'bsc_zyzj',      '应收账款-银行-银行短款' ),
       ('book', '1122.01.001', 'cfee_dqhf',     '应收账款-客户-定期划付客户手续费' ),
       ('book', '6421.01',     'cost_bfee',     '成本-银行手续费支出' ),
       ('book', '6421.02',     'cost_dfss',     '成本-垫付损失' ),
       ('book', '1002.01',     'deposit_bfj',   '银行存款-备付金存款' ),
       ('book', '1002.02',     'deposit_zyzj',  '银行存款-自有资金存款' ),
       ('book', '6603.02',     'fee_jrjg',      '财务费用-金融机构手续费' ),
       ('book', '6021.01',     'income_cfee',   '收入-客户手续费收入' ),
       ('book', '6603.01',     'income_zhlx',   '财务费用-账户利息收入' ),
       ('book', '1020.01',     'txamt_dgd',     '应收银行-待勾兑应收交易款' ),
       ('book', '2241.01',     'txamt_dqr',     '其他应付款-待确认交易款' ),
       ('book', '2005.01',     'txamt_yhyf',    '应付银行-已核应付交易款' ),
       ('book', '1020.02',     'txamt_yhys',    '应收银行-已核应收交易款' ),
       ('book', '3001.03',     'wlzj_yfbf',     '往来-应付备付' ),
       ('book', '3001.04',     'wlzj_yfzy',     '往来-应付自有' ),
       ('book', '3001.01',     'wlzj_ysbf',     '往来-应收备付' ),
       ('book', '3001.02',     'wlzj_yszy',     '往来-应收自有' );
