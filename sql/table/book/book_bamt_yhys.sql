...
comment on column book_bamt_yhys.ys_type   is '原始凭证类型';
comment on column book_bamt_yhys.ys_id     is '原始凭证ID';
comment on column book_bamt_yhys.jzpz_id   is '原始凭证类型';
comment on column book_bamt_yhys.ts_c      is '创建时间';
